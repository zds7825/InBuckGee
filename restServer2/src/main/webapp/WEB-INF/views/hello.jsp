...
<header class="masthead">
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Welcome To Our Web Site!</div>
            <div class="intro-heading text-uppercase">What about today's weather?</div>
...
<section id="services">
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <img src="/resources/img/googlemap.png" width = 128 height = 128>
            </span>
                <h4 class="service-heading">Map</h4>
                <p class="text-muted">By calculating latitude and longitude,
                    It displays the location of the earthquake on the map.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="portfolio-caption">
                    <h4>Real-time earthquake information</h4>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 portfolio-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">About today 's weather situation.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <ul class="timeline">
                    <li>
                        <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="/resources/img/about/aboutweather.png" alt="">
                        </div>
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">기상청의 api를 가져와서 날씨 정보를 제공합니다.</p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="/resources/img/about/aboutearthquake.png" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Real-time Earthquake Information</h4>
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">현재 우리나라에서 지진이 일어났는지 실시간으로 정보를 제공합니다.</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="/resources/img/about/aboutmap.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Map</h4>
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">위도와 경도를 계산해서 지진이 일어난 곳의 위치에 대한 정보를 제공합니다.</p>
                            </div>
                        </div>
                    </li>
