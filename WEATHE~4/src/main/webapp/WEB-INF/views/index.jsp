...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/bootstrap/vendor/font-awesome/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="/resources/bootstrap/css/agency.min.css">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="/aboutAPI">OpenApi</a>
                </li>
            </ul>
        </div>
    </div>
