...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/webjars/startbootstrap-agency/1.0.4/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/webjars/startbootstrap-agency/1.0.4/css/agency.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/webjars/startbootstrap-agency/1.0.4/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">향긋이네 기상청</a>
        </div>
