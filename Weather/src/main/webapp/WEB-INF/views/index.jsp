        ...
        <div class="row text-center">
            ...
            <span class="fa-stack fa-4x">
              <img src="/resources/img/dustinformation.png" width = 128 height = 128>
                ...
                <p class="text-muted">
                    Provides information about today's atmospheric conditions, temperature, and humidity.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                    ...
                    <img class="img-fluid" src="/resources/img/portfolio/WeatherInformation.jpg" alt="">
                </a>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
                    ...
                    <img class="img-fluid" src="/resources/img/portfolio/Real-TimeEarthquake.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>실시간 지진 정보</h4>
            </div>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
                    ...
                    <img src="/resources/img/portfolio/SensibleTemperature.jpg" width=350 height=197 alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>체감 온도</h4>
                </div>
                ...
                <ul class="timeline">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4><br>조인선</h4>
                                <h4 class="subheading">20121326127</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">학과 : 컴퓨터 공학부
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">학과 : 컴퓨터 공학부
                                    ...
                                    <br>이메일 : zds7825@koreatech.ac.kr</p>
                            </div>
                        </div>
                    </li>
                </ul>
